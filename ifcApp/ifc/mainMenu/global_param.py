...
class GlobalParam(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        if self.query_in_global_param_table == []:
            ...
            insert_into_setting_sensor_table6 = GlobalParamTable(id=5, min_value=5, max_value=600, normal_value=700)
            insert_into_setting_sensor_table7 = GlobalParamTable(id=6, min_value=5, max_value=800, normal_value=700)
            insert_into_setting_sensor_table8 = GlobalParamTable(id=7, min_value=5, max_value=500, normal_value=700)
            insert_into_setting_sensor_table9 = GlobalParamTable(id=8, min_value=5, max_value=400, normal_value=700)
            insert_into_setting_sensor_table10 = GlobalParamTable(id=9, min_value=5, max_value=600, normal_value=700)
            insert_into_setting_sensor_table11 = GlobalParamTable(id=10, min_value=5, max_value=300, normal_value=700)
            insert_into_setting_sensor_table12 = GlobalParamTable(id=11, min_value=5, max_value=600, normal_value=700)
            insert_into_setting_sensor_table13 = GlobalParamTable(id=12, min_value=5, max_value=400, normal_value=700)
            insert_into_setting_sensor_table14 = GlobalParamTable(id=13, min_value=5, max_value=500, normal_value=700)
            insert_into_setting_sensor_table15 = GlobalParamTable(id=14, min_value=5, max_value=200, normal_value=700)
            insert_into_setting_sensor_table5 = GlobalParamTable(id=15, min_value=5, max_value=100, normal_value=700)
